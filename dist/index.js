...
`;function Hr({metadata:o}){return jsxRuntime.jsxs("div",{className:Te,children:[jsxRuntime.jsx("div",{className:be,children:"Session Details"}),jsxRuntime.jsxs("div",{className:q,children:[jsxRuntime.jsx("span",{className:_,children:"User"}),jsxRuntime.jsx("span",{className:j,children:o.userId||"Anonymous"})]}),jsxRuntime.jsxs("div",{className:q,children:[jsxRuntime.jsx("span",{className:_,children:"Session ID"}),jsxRuntime.jsx("span",{className:to,children:o.sessionId||"N/A"})]}),jsxRuntime.jsxs("div",{className:q,children:[jsxRuntime.jsx("span",{className:_,children:"Browser"}),jsxRuntime.jsxs("span",{className:j,children:[o.browser," \xB7 ",o.platform]})]}),jsxRuntime.jsxs("div",{className:q,children:[jsxRuntime.jsx("span",{className:_,children:"Screen"}),jsxRuntime.jsx("span",{className:j,children:o.screenResolution})]}),jsxRuntime.jsxs("div",{className:q,children:[jsxRuntime.jsx("span",{className:_,children:"Timezone"}),jsxRuntime.jsx("span",{className:j,children:o.timezone})]}),jsxRuntime.jsxs("div",{className:q,children:[jsxRuntime.jsx("span",{className:_,children:"Language"}),jsxRuntime.jsx("span",{className:j,children:o.language})]}),jsxRuntime.jsxs("div",{className:q,children:[jsxRuntime.jsx("span",{className:_,children:"Viewport"}),jsxRuntime.jsx("span",{className:j,children:o.viewport})]})]})}function Ar({copyFormat:o,setCopyFormat:e,onSaveToDirectory:t,onCloseDropdown:s}){let l=["json","ecs.json","ai.txt"],i={json:jsxRuntime.jsx(lucideReact.FileJson,{size:14}),"ecs.json":jsxRuntime.jsx(lucideReact.FileText,{size:14}),"ai.txt":jsxRuntime.jsx(lucideReact.FileText,{size:14})};return jsxRuntime.jsxs("div",{className:Te,children:[jsxRuntime.jsx("div",{className:be,children:"Export format"}),jsxRuntime.jsx("div",{style:{display:"flex",flexDirection:"column",gap:2},children:l.map(n=>jsxRuntime.jsxs("button",{type:"button",className:Ne,style:o===n?{background:"rgba(0, 0, 0, 0.06)",color:"rgba(0, 0, 0, 0.9)"}:void 0,onClick:()=>{e(n),s();},children:[i[n],jsxRuntime.jsxs("span",{style:{flex:1},children:[n==="json"&&"JSON",n==="ecs.json"&&"ECS (AI)",n==="ai.txt"&&"AI-TXT"]}),o===n&&jsxRuntime.jsx("span",{className:no,children:"\u2713"})]},n))}),jsxRuntime.jsx("div",{className:so}),jsxRuntime.jsx("div",{className:be,children:"Actions"}),jsxRuntime.jsxs("button",{type:"button",className:Ne,onClick:()=>{t(),s();},children:[jsxRuntime.jsx(lucideReact.Save,{size:14}),jsxRuntime.jsx("span",{children:"Save to folder"})]})]})}var _o=react.forwardRef(function({metadata:e,onClose:t,onSaveToDirectory:s,onClear:l,isSettingsOpen:i,openSettings:n,closeSettings:d,isSessionDetailsOpen:c,openSessionDetails:f,closeSessionDetails:m},b){let{copyFormat:$,setCopyFormat:D}=Ce();return jsxRuntime.jsx(jsxRuntime.Fragment,{children:jsxRuntime.jsxs("div",{className:Ke,children:[jsxRuntime.jsx("div",{className:Mo,children:jsxRuntime.jsx("h3",{className:Ge,children:"Debug"})}),jsxRuntime.jsxs("div",{style:{display:"flex",gap:"4px",alignItems:"center"},children:[jsxRuntime.jsx("button",{type:"button",onClick:l,className:Ve,"aria-label":"Clear all logs",title:"Clear logs",children:jsxRuntime.jsx(lucideReact.Trash2,{size:16})}),jsxRuntime.jsxs(I__namespace.Root,{open:c,onOpenChange:g=>{g?f():m();},children:[jsxRuntime.jsx(I__namespace.Trigger,{asChild:true,children:jsxRuntime.jsx("button",{type:"button",className:Ee,"aria-label":"Session details",title:"Session details",children:jsxRuntime.jsx(lucideReact.Info,{size:16})})}),jsxRuntime.jsx(I__namespace.Portal,{children:jsxRuntime.jsx(I__namespace.Content,{sideOffset:6,align:"end",style:{zIndex:1e5},onPointerDownOutside:g=>{g.target.closest("#debug-panel")&&g.preventDefault();},children:jsxRuntime.jsx(Hr,{metadata:e})})})]}),jsxRuntime.jsxs(I__namespace.Root,{open:i,onOpenChange:g=>{g?n():d();},children:[jsxRuntime.jsx(I__namespace.Trigger,{asChild:true,children:jsxRuntime.jsx("button",{type:"button",className:Ee,"aria-label":"Actions and settings",title:"Actions and settings","data-settings-trigger":"true",children:jsxRuntime.jsx(lucideReact.Settings,{size:16})})}),jsxRuntime.jsx(I__namespace.Portal,{children:jsxRuntime.jsx(I__namespace.Content,{"data-settings-dropdown":"true",sideOffset:6,align:"end",style:{zIndex:1e5},onPointerDownOutside:g=>{g.target.closest("#debug-panel")&&g.preventDefault();},children:jsxRuntime.jsx(Ar,{copyFormat:$,setCopyFormat:D,onSaveToDirectory:s,onCloseDropdown:()=>d()})})})]}),jsxRuntime.jsx("button",{ref:b,type:"button",onClick:t,className:Je,"aria-label":"Close debug panel",children:jsxRuntime.jsx(lucideReact.X,{size:18})})]})]})})});function jo({logCount:o,errorCount:e,networkErrorCount:t}){return jsxRuntime.jsxs("div",{className:Ye,children:[jsxRuntime.jsxs("div",{className:de,children:[jsxRuntime.jsx("div",{className:pe,children:o.toLocaleString()}),jsxRuntime.jsx("div",{className:ue,children:"Logs"})]}),jsxRuntime.jsxs("div",{className:de,children:[jsxRuntime.jsx("div",{className:`${pe} ${Oo}`,children:e.toLocaleString()}),jsxRuntime.jsx("div",{className:ue,children:"Errors"})]}),jsxRuntime.jsxs("div",{className:de,children:[jsxRuntime.jsx("div",{className:`${pe} ${Fo}`,children:t.toLocaleString()}),jsxRuntime.jsx("div",{className:ue,children:"Network"})]})]})}function B({children:o,content:e,disabled:t,...s}){return jsxRuntime.jsx(M__namespace.Provider,{delayDuration:200,skipDelayDuration:100,children:jsxRuntime.jsxs(M__namespace.Root,{children:[jsxRuntime.jsx(M__namespace.Trigger,{asChild:true,children:jsxRuntime.jsx("button",{type:"button",disabled:t,...s,children:o})}),!t&&jsxRuntime.jsx(M__namespace.Portal,{children:jsxRuntime.jsxs(M__namespace.Content,{side:"top",sideOffset:6,align:"center",style:{background:"var(--color-primary, #1a1a2e)",color:"white",padding:"6px 12px",borderRadius:"6px",fontSize:"11px",fontWeight:500,boxShadow:"0 4px 16px rgba(0,0,0,0.2)",zIndex:1e5},children:[e,jsxRuntime.jsx(M__namespace.Arrow,{style:{fill:"var(--color-primary, #1a1a2e)"}})]})})]})})}function Uo({logCount:o,hasUploadEndpoint:e,isUploading:t,getFilteredLogCount:s,onCopyFiltered:l,onDownload:i,onCopy:n,onUpload:d}){let c=o===0;return jsxRuntime.jsxs("div",{className:We,children:[jsxRuntime.jsxs("div",{className:Le,children:[jsxRuntime.jsx("div",{className:ge,children:"Copy Filtered"}),jsxRuntime.jsxs("div",{className:De,children:[jsxRuntime.jsxs(B,{content:"Copy only console logs",disabled:c||s("logs")===0,onClick:()=>l("logs"),className:A,"aria-label":"Copy only console logs",children:[jsxRuntime.jsx(lucideReact.Terminal,{size:18}),"Logs"]}),jsxRuntime.jsxs(B,{content:"Copy only errors",disabled:c||s("errors")===0,onClick:()=>l("errors"),className:A,"aria-label":"Copy only errors",children:[jsxRuntime.jsx(lucideReact.AlertCircle,{size:18}),"Errors"]}),jsxRuntime.jsxs(B,{content:"Copy only network requests",disabled:c||s("network")===0,onClick:()=>l("network"),className:A,"aria-label":"Copy only network requests",children:[jsxRuntime.jsx(lucideReact.Globe,{size:18}),"Network"]})]})]}),jsxRuntime.jsxs("div",{className:Le,children:[jsxRuntime.jsx("div",{className:ge,children:"Export"}),jsxRuntime.jsxs("div",{className:De,children:[jsxRuntime.jsxs(B,{content:"Download as JSON",disabled:c,onClick:()=>i("json"),className:A,"aria-label":"Download as JSON",children:[jsxRuntime.jsx(lucideReact.FileJson,{size:18}),"JSON"]}),jsxRuntime.jsxs(B,{content:"Download as TXT",disabled:c,onClick:()=>i("txt"),className:A,"aria-label":"Download as TXT",children:[jsxRuntime.jsx(lucideReact.FileText,{size:18}),"TXT"]}),jsxRuntime.jsxs(B,{content:"Download as JSONL",disabled:c,onClick:()=>i("jsonl"),className:A,"aria-label":"Download as JSONL",children:[jsxRuntime.jsx(lucideReact.Database,{size:18}),"JSONL"]})]})]}),jsxRuntime.jsxs("div",{className:Le,children:[jsxRuntime.jsx("div",{className:ge,children:"Actions"}),jsxRuntime.jsxs("div",{className:De,children:[jsxRuntime.jsxs(B,{content:"Copy all to clipboard",disabled:c,onClick:n,className:A,"aria-label":"Copy all to clipboard",children:[jsxRuntime.jsx(lucideReact.Copy,{size:18}),"Copy"]}),jsxRuntime.jsxs(B,{content:"Download AI-optimized format",disabled:c,onClick:()=>i("ai.txt"),className:A,"aria-label":"Download AI-optimized format",children:[jsxRuntime.jsx(lucideReact.FileText,{size:18}),"AI-TXT"]}),e?jsxRuntime.jsxs(B,{content:"Upload logs to server",disabled:t,onClick:d,className:Qe,"aria-label":"Upload logs to server",children:[jsxRuntime.jsx(lucideReact.CloudUpload,{size:18}),t?"Uploading...":"Upload"]}):jsxRuntime.jsx("div",{})]})]})]})}function ao({status:o}){return jsxRuntime.jsxs("div",{"aria-live":"polite",className:o.type==="success"?Ze:eo,children:[o.type==="success"?jsxRuntime.jsx(lucideReact.CheckCircle2,{size:14}):jsxRuntime.jsx(lucideReact.AlertCircle,{size:14}),jsxRuntime.jsx("span",{className:zo,children:o.message})]})}function qo({uploadStatus:o,directoryStatus:e,copyStatus:t}){return jsxRuntime.jsxs("div",{className:Po,children:[o&&jsxRuntime.jsx(ao,{status:o}),e&&jsxRuntime.jsx(ao,{status:e}),t&&jsxRuntime.jsx(ao,{status:t})]})}function Go(){return jsxRuntime.jsx("div",{className:oo,children:jsxRuntime.jsxs("div",{className:ro,children:["Press ",jsxRuntime.jsx("kbd",{children:"Ctrl+Shift+D"})," to toggle"]})})}function Wo(o,e){switch(e){case "logs":return o.filter(t=>t.type==="CONSOLE");case "errors":return o.filter(t=>t.type==="CONSOLE"&&t.level==="error");case "network":return o.filter(t=>t.type==="FETCH_REQ"||t.type==="FETCH_RES"||t.type==="XHR_REQ"||t.type==="XHR_RES");case "networkErrors":return o.filter(t=>t.type==="FETCH_ERR"||t.type==="XHR_ERR");default:return o}}function lo({user:o,environment:e="production",uploadEndpoint:t,fileNameTemplate:s="{env}_{date}_{time}_{userId}_{errorCount}errors",maxLogs:l=2e3,showInProduction:i=false}){let{isOpen:n,open:d,close:c}=$o(),{isSettingsOpen:f,openSettings:m,closeSettings:b}=Lo(),{copyFormat:$}=Ce(),[D,g]=react.useState(false),R=react.useCallback(()=>{g(true);},[]),T=react.useCallback(()=>{g(false);},[]),{uploadStatus:K,setUploadStatus:h,directoryStatus:Oe,setDirectoryStatus:ee,copyStatus:Fe,setCopyStatus:O}=Eo(),G=react.useRef(null),y=react.useRef(null),{downloadLogs:w,uploadLogs:x,clearLogs:N,getLogs:S,getLogCount:ye,getMetadata:ie}=ce({fileNameTemplate:s,environment:e,userId:o?.id||o?.email||"guest",includeMetadata:true,uploadEndpoint:t,maxLogs:l,captureConsole:true,captureFetch:true,captureXHR:true,sanitizeKeys:["password","token","apiKey","secret","authorization","creditCard"],excludeUrls:["/api/analytics","google-analytics.com","facebook.com","vercel.com"]}),[co,or]=react.useState(0);react.useEffect(()=>{let u=()=>or(ye());u();let E=setInterval(u,100);return ()=>clearInterval(E)},[ye]);let J=ie();react.useEffect(()=>{if(J.errorCount>=5&&t){let u=async()=>{try{await x();}catch{console.warn("[DebugPanel] Failed to auto-upload logs");}};return window.addEventListener("error",u),()=>window.removeEventListener("error",u)}},[J.errorCount,t,x]);let xe=react.useCallback((u,E)=>{if($==="json")return JSON.stringify({metadata:E,logs:u},null,2);if($==="ecs.json"){let V=u.map(re=>H(re,E)),oe={metadata:W(E),logs:V};return JSON.stringify(oe,null,2)}else if($==="ai.txt"){let V=`# METADATA
