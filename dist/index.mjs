...
`;function qt({metadata:o}){return jsxs("div",{className:Me,children:[jsx("div",{className:xe,children:"Session Details"}),jsxs("div",{className:W,children:[jsx("span",{className:K,children:"User"}),jsx("span",{className:J,children:o.userId||"Anonymous"})]}),jsxs("div",{className:W,children:[jsx("span",{className:K,children:"Session ID"}),jsx("span",{className:ao,children:o.sessionId||"N/A"})]}),jsxs("div",{className:W,children:[jsx("span",{className:K,children:"Browser"}),jsxs("span",{className:J,children:[o.browser," \xB7 ",o.platform]})]}),jsxs("div",{className:W,children:[jsx("span",{className:K,children:"Screen"}),jsx("span",{className:J,children:o.screenResolution})]}),jsxs("div",{className:W,children:[jsx("span",{className:K,children:"Timezone"}),jsx("span",{className:J,children:o.timezone})]}),jsxs("div",{className:W,children:[jsx("span",{className:K,children:"Language"}),jsx("span",{className:J,children:o.language})]}),jsxs("div",{className:W,children:[jsx("span",{className:K,children:"Viewport"}),jsx("span",{className:J,children:o.viewport})]})]})}function zt({copyFormat:o,setCopyFormat:e,onSaveToDirectory:t,onCloseDropdown:s}){let a=["json","ecs.json","ai.txt"],i={json:jsx(FileJson,{size:14}),"ecs.json":jsx(FileText,{size:14}),"ai.txt":jsx(FileText,{size:14})};return jsxs("div",{className:Me,children:[jsx("div",{className:xe,children:"Export format"}),jsx("div",{style:{display:"flex",flexDirection:"column",gap:2},children:a.map(n=>jsxs("button",{type:"button",className:Oe,style:o===n?{background:"rgba(0, 0, 0, 0.06)",color:"rgba(0, 0, 0, 0.9)"}:void 0,onClick:()=>{e(n),s();},children:[i[n],jsxs("span",{style:{flex:1},children:[n==="json"&&"JSON",n==="ecs.json"&&"ECS (AI)",n==="ai.txt"&&"AI-TXT"]}),o===n&&jsx("span",{className:io,children:"\u2713"})]},n))}),jsx("div",{className:lo}),jsx("div",{className:xe,children:"Actions"}),jsxs("button",{type:"button",className:Oe,onClick:()=>{t(),s();},children:[jsx(Save,{size:14}),jsx("span",{children:"Save to folder"})]})]})}var Bo=forwardRef(function({metadata:e,onClose:t,onSaveToDirectory:s,onClear:a,isSettingsOpen:i,openSettings:n,closeSettings:d,isSessionDetailsOpen:c,openSessionDetails:f,closeSessionDetails:h},b){let{copyFormat:S,setCopyFormat:z}=Ee();return jsx(Fragment,{children:jsxs("div",{className:Ve,children:[jsx("div",{className:Fo,children:jsx("h3",{className:Ye,children:"Debug"})}),jsxs("div",{style:{display:"flex",gap:"4px",alignItems:"center"},children:[jsx("button",{type:"button",onClick:a,className:Qe,"aria-label":"Clear all logs",title:"Clear logs",children:jsx(Trash2,{size:16})}),jsxs(H.Root,{open:c,onOpenChange:g=>{g?f():h();},children:[jsx(H.Trigger,{asChild:true,children:jsx("button",{type:"button",className:De,"aria-label":"Session details",title:"Session details",children:jsx(Info,{size:16})})}),jsx(H.Portal,{children:jsx(H.Content,{sideOffset:6,align:"end",style:{zIndex:1e5},onPointerDownOutside:g=>{g.target.closest("#debug-panel")&&g.preventDefault();},children:jsx(qt,{metadata:e})})})]}),jsxs(H.Root,{open:i,onOpenChange:g=>{g?n():d();},children:[jsx(H.Trigger,{asChild:true,children:jsx("button",{type:"button",className:De,"aria-label":"Actions and settings",title:"Actions and settings","data-settings-trigger":"true",children:jsx(Settings,{size:16})})}),jsx(H.Portal,{children:jsx(H.Content,{"data-settings-dropdown":"true",sideOffset:6,align:"end",style:{zIndex:1e5},onPointerDownOutside:g=>{g.target.closest("#debug-panel")&&g.preventDefault();},children:jsx(zt,{copyFormat:S,setCopyFormat:z,onSaveToDirectory:s,onCloseDropdown:()=>d()})})})]}),jsx("button",{ref:b,type:"button",onClick:t,className:We,"aria-label":"Close debug panel",children:jsx(X,{size:18})})]})]})})});function jo({logCount:o,errorCount:e,networkErrorCount:t}){return jsxs("div",{className:Ze,children:[jsxs("div",{className:fe,children:[jsx("div",{className:be,children:o.toLocaleString()}),jsx("div",{className:me,children:"Logs"})]}),jsxs("div",{className:fe,children:[jsx("div",{className:`${be} ${Ao}`,children:e.toLocaleString()}),jsx("div",{className:me,children:"Errors"})]}),jsxs("div",{className:fe,children:[jsx("div",{className:`${be} ${Po}`,children:t.toLocaleString()}),jsx("div",{className:me,children:"Network"})]})]})}function V({children:o,content:e,disabled:t,...s}){return jsx(q.Provider,{delayDuration:200,skipDelayDuration:100,children:jsxs(q.Root,{children:[jsx(q.Trigger,{asChild:true,children:jsx("button",{type:"button",disabled:t,...s,children:o})}),!t&&jsx(q.Portal,{children:jsxs(q.Content,{side:"top",sideOffset:6,align:"center",style:{background:"var(--color-primary, #1a1a2e)",color:"white",padding:"6px 12px",borderRadius:"6px",fontSize:"11px",fontWeight:500,boxShadow:"0 4px 16px rgba(0,0,0,0.2)",zIndex:1e5},children:[e,jsx(q.Arrow,{style:{fill:"var(--color-primary, #1a1a2e)"}})]})})]})})}function Go({logCount:o,hasUploadEndpoint:e,isUploading:t,getFilteredLogCount:s,onCopyFiltered:a,onDownload:i,onCopy:n,onUpload:d}){let c=o===0;return jsxs("div",{className:eo,children:[jsxs("div",{className:Te,children:[jsx("div",{className:ye,children:"Copy Filtered"}),jsxs("div",{className:Ne,children:[jsxs(V,{content:"Copy only console logs",disabled:c||s("logs")===0,onClick:()=>a("logs"),className:_,"aria-label":"Copy only console logs",children:[jsx(Terminal,{size:18}),"Logs"]}),jsxs(V,{content:"Copy only errors",disabled:c||s("errors")===0,onClick:()=>a("errors"),className:_,"aria-label":"Copy only errors",children:[jsx(AlertCircle,{size:18}),"Errors"]}),jsxs(V,{content:"Copy only network requests",disabled:c||s("network")===0,onClick:()=>a("network"),className:_,"aria-label":"Copy only network requests",children:[jsx(Globe,{size:18}),"Network"]})]})]}),jsxs("div",{className:Te,children:[jsx("div",{className:ye,children:"Export"}),jsxs("div",{className:Ne,children:[jsxs(V,{content:"Download as JSON",disabled:c,onClick:()=>i("json"),className:_,"aria-label":"Download as JSON",children:[jsx(FileJson,{size:18}),"JSON"]}),jsxs(V,{content:"Download as TXT",disabled:c,onClick:()=>i("txt"),className:_,"aria-label":"Download as TXT",children:[jsx(FileText,{size:18}),"TXT"]}),jsxs(V,{content:"Download as JSONL",disabled:c,onClick:()=>i("jsonl"),className:_,"aria-label":"Download as JSONL",children:[jsx(Database,{size:18}),"JSONL"]})]})]}),jsxs("div",{className:Te,children:[jsx("div",{className:ye,children:"Actions"}),jsxs("div",{className:Ne,children:[jsxs(V,{content:"Copy all to clipboard",disabled:c,onClick:n,className:_,"aria-label":"Copy all to clipboard",children:[jsx(Copy,{size:18}),"Copy"]}),jsxs(V,{content:"Download AI-optimized format",disabled:c,onClick:()=>i("ai.txt"),className:_,"aria-label":"Download AI-optimized format",children:[jsx(FileText,{size:18}),"AI-TXT"]}),e?jsxs(V,{content:"Upload logs to server",disabled:t,onClick:d,className:oo,"aria-label":"Upload logs to server",children:[jsx(CloudUpload,{size:18}),t?"Uploading...":"Upload"]}):jsx("div",{})]})]})]})}function co({status:o}){return jsxs("div",{"aria-live":"polite",className:o.type==="success"?to:ro,children:[o.type==="success"?jsx(CheckCircle2,{size:14}):jsx(AlertCircle,{size:14}),jsx("span",{className:qo,children:o.message})]})}function _o({uploadStatus:o,directoryStatus:e,copyStatus:t}){return jsxs("div",{className:Ho,children:[o&&jsx(co,{status:o}),e&&jsx(co,{status:e}),t&&jsx(co,{status:t})]})}function Vo(){return jsx("div",{className:no,children:jsxs("div",{className:so,children:["Press ",jsx("kbd",{children:"Ctrl+Shift+D"})," to toggle"]})})}function Wo(o,e){switch(e){case "logs":return o.filter(t=>t.type==="CONSOLE");case "errors":return o.filter(t=>t.type==="CONSOLE"&&t.level==="error");case "network":return o.filter(t=>t.type==="FETCH_REQ"||t.type==="FETCH_RES"||t.type==="XHR_REQ"||t.type==="XHR_RES");case "networkErrors":return o.filter(t=>t.type==="FETCH_ERR"||t.type==="XHR_ERR");default:return o}}function po({user:o,environment:e="production",uploadEndpoint:t,fileNameTemplate:s="{env}_{date}_{time}_{userId}_{errorCount}errors",maxLogs:a=2e3,showInProduction:i=false}){let{isOpen:n,open:d,close:c}=Eo(),{isSettingsOpen:f,openSettings:h,closeSettings:b}=Do(),{copyFormat:S}=Ee(),[z,g]=useState(false),L=useCallback(()=>{g(true);},[]),j=useCallback(()=>{g(false);},[]),{uploadStatus:Z,setUploadStatus:k,directoryStatus:Pe,setDirectoryStatus:ae,copyStatus:He,setCopyStatus:w}=Lo(),ee=useRef(null),y=useRef(null),{downloadLogs:F,uploadLogs:A,clearLogs:X,getLogs:u,getMetadata:x,_logCount:D}=ge({fileNameTemplate:s,environment:e,userId:o?.id||o?.email||"guest",includeMetadata:true,uploadEndpoint:t,maxLogs:a,captureConsole:true,captureFetch:true,captureXHR:true,sanitizeKeys:["password","token","apiKey","secret","authorization","creditCard"],excludeUrls:["/api/analytics","google-analytics.com","facebook.com","vercel.com"]}),R=D,P=x();useEffect(()=>{if(P.errorCount>=5&&t){let m=async()=>{try{await A();}catch{console.warn("[DebugPanel] Failed to auto-upload logs");}};return window.addEventListener("error",m),()=>window.removeEventListener("error",m)}},[P.errorCount,t,A]);let ve=useCallback((m,M)=>{if(S==="json")return JSON.stringify({metadata:M,logs:m},null,2);if(S==="ecs.json"){let oe=m.map(le=>G(le,M)),ie={metadata:re(M),logs:oe};return JSON.stringify(ie,null,2)}else if(S==="ai.txt"){let oe=`# METADATA
