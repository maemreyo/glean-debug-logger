...
`;function zt({metadata:o}){return jsxs("div",{className:Ne,children:[jsx("div",{className:xe,children:"Session Details"}),jsxs("div",{className:J,children:[jsx("span",{className:U,children:"User"}),jsx("span",{className:X,children:o.userId||"Anonymous"})]}),jsxs("div",{className:J,children:[jsx("span",{className:U,children:"Session ID"}),jsx("span",{className:ao,children:o.sessionId||"N/A"})]}),jsxs("div",{className:J,children:[jsx("span",{className:U,children:"Browser"}),jsxs("span",{className:X,children:[o.browser," \xB7 ",o.platform]})]}),jsxs("div",{className:J,children:[jsx("span",{className:U,children:"Screen"}),jsx("span",{className:X,children:o.screenResolution})]}),jsxs("div",{className:J,children:[jsx("span",{className:U,children:"Timezone"}),jsx("span",{className:X,children:o.timezone})]}),jsxs("div",{className:J,children:[jsx("span",{className:U,children:"Language"}),jsx("span",{className:X,children:o.language})]}),jsxs("div",{className:J,children:[jsx("span",{className:U,children:"Viewport"}),jsx("span",{className:X,children:o.viewport})]})]})}function Ht({copyFormat:o,setCopyFormat:e,onSaveToDirectory:t,onCloseDropdown:a}){let s=["json","ecs.json","ai.txt"],l={json:jsx(FileJson,{size:14}),"ecs.json":jsx(FileText,{size:14}),"ai.txt":jsx(FileText,{size:14})};return jsxs("div",{className:Ne,children:[jsx("div",{className:xe,children:"Export format"}),jsx("div",{style:{display:"flex",flexDirection:"column",gap:2},children:s.map(n=>jsxs("button",{type:"button",className:Oe,style:o===n?{background:"rgba(0, 0, 0, 0.06)",color:"rgba(0, 0, 0, 0.9)"}:void 0,onClick:()=>{e(n),a();},children:[l[n],jsxs("span",{style:{flex:1},children:[n==="json"&&"JSON",n==="ecs.json"&&"ECS (AI)",n==="ai.txt"&&"AI-TXT"]}),o===n&&jsx("span",{className:io,children:"\u2713"})]},n))}),jsx("div",{className:lo}),jsx("div",{className:xe,children:"Actions"}),jsxs("button",{type:"button",className:Oe,onClick:()=>{t(),a();},children:[jsx(Save,{size:14}),jsx("span",{children:"Save to folder"})]})]})}var qo=forwardRef(function({metadata:e,onClose:t,onSaveToDirectory:a,onClear:s,isSettingsOpen:l,openSettings:n,closeSettings:d,isSessionDetailsOpen:c,openSessionDetails:b,closeSessionDetails:m},f){let{copyFormat:S,setCopyFormat:E}=Re();return jsx(Fragment,{children:jsxs("div",{className:Ve,children:[jsx("div",{className:Mo,children:jsx("h3",{className:Ye,children:"Debug"})}),jsxs("div",{style:{display:"flex",gap:"4px",alignItems:"center"},children:[jsx("button",{type:"button",onClick:s,className:Qe,"aria-label":"Clear all logs",title:"Clear logs",children:jsx(Trash2,{size:16})}),jsxs(F.Root,{open:c,onOpenChange:g=>{g?b():m();},children:[jsx(F.Trigger,{asChild:true,children:jsx("button",{type:"button",className:De,"aria-label":"Session details",title:"Session details",children:jsx(Info,{size:16})})}),jsx(F.Portal,{children:jsx(F.Content,{sideOffset:6,align:"end",style:{zIndex:1e5},onPointerDownOutside:g=>{g.target.closest("#debug-panel")&&g.preventDefault();},children:jsx(zt,{metadata:e})})})]}),jsxs(F.Root,{open:l,onOpenChange:g=>{g?n():d();},children:[jsx(F.Trigger,{asChild:true,children:jsx("button",{type:"button",className:De,"aria-label":"Actions and settings",title:"Actions and settings","data-settings-trigger":"true",children:jsx(Settings,{size:16})})}),jsx(F.Portal,{children:jsx(F.Content,{"data-settings-dropdown":"true",sideOffset:6,align:"end",style:{zIndex:1e5},onPointerDownOutside:g=>{g.target.closest("#debug-panel")&&g.preventDefault();},children:jsx(Ht,{copyFormat:S,setCopyFormat:E,onSaveToDirectory:a,onCloseDropdown:()=>d()})})})]}),jsx("button",{ref:f,type:"button",onClick:t,className:We,"aria-label":"Close debug panel",children:jsx(X$1,{size:18})})]})]})})});function Bo({logCount:o,errorCount:e,networkErrorCount:t}){return jsxs("div",{className:Ze,children:[jsxs("div",{className:fe,children:[jsx("div",{className:be,children:o.toLocaleString()}),jsx("div",{className:me,children:"Logs"})]}),jsxs("div",{className:fe,children:[jsx("div",{className:`${be} ${Fo}`,children:e.toLocaleString()}),jsx("div",{className:me,children:"Errors"})]}),jsxs("div",{className:fe,children:[jsx("div",{className:`${be} ${Po}`,children:t.toLocaleString()}),jsx("div",{className:me,children:"Network"})]})]})}function G({children:o,content:e,disabled:t,...a}){return jsx(P.Provider,{delayDuration:200,skipDelayDuration:100,children:jsxs(P.Root,{children:[jsx(P.Trigger,{asChild:true,children:jsx("button",{type:"button",disabled:t,...a,children:o})}),!t&&jsx(P.Portal,{children:jsxs(P.Content,{side:"top",sideOffset:6,align:"center",style:{background:"var(--color-primary, #1a1a2e)",color:"white",padding:"6px 12px",borderRadius:"6px",fontSize:"11px",fontWeight:500,boxShadow:"0 4px 16px rgba(0,0,0,0.2)",zIndex:1e5},children:[e,jsx(P.Arrow,{style:{fill:"var(--color-primary, #1a1a2e)"}})]})})]})})}function Uo({logCount:o,hasUploadEndpoint:e,isUploading:t,getFilteredLogCount:a,onCopyFiltered:s,onDownload:l,onCopy:n,onUpload:d}){let c=o===0;return jsxs("div",{className:eo,children:[jsxs("div",{className:Ie,children:[jsx("div",{className:ye,children:"Copy Filtered"}),jsxs("div",{className:Te,children:[jsxs(G,{content:"Copy only console logs",disabled:c||a("logs")===0,onClick:()=>s("logs"),className:j,"aria-label":"Copy only console logs",children:[jsx(Terminal,{size:18}),"Logs"]}),jsxs(G,{content:"Copy only errors",disabled:c||a("errors")===0,onClick:()=>s("errors"),className:j,"aria-label":"Copy only errors",children:[jsx(AlertCircle,{size:18}),"Errors"]}),jsxs(G,{content:"Copy only network requests",disabled:c||a("network")===0,onClick:()=>s("network"),className:j,"aria-label":"Copy only network requests",children:[jsx(Globe,{size:18}),"Network"]})]})]}),jsxs("div",{className:Ie,children:[jsx("div",{className:ye,children:"Export"}),jsxs("div",{className:Te,children:[jsxs(G,{content:"Download as JSON",disabled:c,onClick:()=>l("json"),className:j,"aria-label":"Download as JSON",children:[jsx(FileJson,{size:18}),"JSON"]}),jsxs(G,{content:"Download as TXT",disabled:c,onClick:()=>l("txt"),className:j,"aria-label":"Download as TXT",children:[jsx(FileText,{size:18}),"TXT"]}),jsxs(G,{content:"Download as JSONL",disabled:c,onClick:()=>l("jsonl"),className:j,"aria-label":"Download as JSONL",children:[jsx(Database,{size:18}),"JSONL"]})]})]}),jsxs("div",{className:Ie,children:[jsx("div",{className:ye,children:"Actions"}),jsxs("div",{className:Te,children:[jsxs(G,{content:"Copy all to clipboard",disabled:c,onClick:n,className:j,"aria-label":"Copy all to clipboard",children:[jsx(Copy,{size:18}),"Copy"]}),jsxs(G,{content:"Download AI-optimized format",disabled:c,onClick:()=>l("ai.txt"),className:j,"aria-label":"Download AI-optimized format",children:[jsx(FileText,{size:18}),"AI-TXT"]}),e?jsxs(G,{content:"Upload logs to server",disabled:t,onClick:d,className:oo,"aria-label":"Upload logs to server",children:[jsx(CloudUpload,{size:18}),t?"Uploading...":"Upload"]}):jsx("div",{})]})]})]})}function co({status:o}){return jsxs("div",{"aria-live":"polite",className:o.type==="success"?to:ro,children:[o.type==="success"?jsx(CheckCircle2,{size:14}):jsx(AlertCircle,{size:14}),jsx("span",{className:zo,children:o.message})]})}function Xo({uploadStatus:o,directoryStatus:e,copyStatus:t}){return jsxs("div",{className:Ao,children:[o&&jsx(co,{status:o}),e&&jsx(co,{status:e}),t&&jsx(co,{status:t})]})}function Jo(){return jsx("div",{className:no,children:jsxs("div",{className:so,children:["Press ",jsx("kbd",{children:"Ctrl+Shift+D"})," to toggle"]})})}function Yo(o,e){switch(e){case "logs":return o.filter(t=>t.type==="CONSOLE");case "errors":return o.filter(t=>t.type==="CONSOLE"&&t.level==="error");case "network":return o.filter(t=>t.type==="FETCH_REQ"||t.type==="FETCH_RES"||t.type==="XHR_REQ"||t.type==="XHR_RES");case "networkErrors":return o.filter(t=>t.type==="FETCH_ERR"||t.type==="XHR_ERR");default:return o}}function uo({user:o,environment:e="production",uploadEndpoint:t,fileNameTemplate:a="{env}_{date}_{time}_{userId}_{errorCount}errors",maxLogs:s=2e3,showInProduction:l=false}){let{isOpen:n,open:d,close:c}=Ro(),{isSettingsOpen:b,openSettings:m,closeSettings:f}=Do(),{copyFormat:S}=Re(),[E,g]=useState(false),L=useCallback(()=>{g(true);},[]),I=useCallback(()=>{g(false);},[]),{uploadStatus:Y,setUploadStatus:k,directoryStatus:Pe,setDirectoryStatus:re,copyStatus:Ae,setCopyStatus:A}=Lo(),N=useRef(null),W=useRef(null),{downloadLogs:y,uploadLogs:M,clearLogs:q,getLogs:x,getLogCount:w,getMetadata:h}=ge({fileNameTemplate:a,environment:e,userId:o?.id||o?.email||"guest",includeMetadata:true,uploadEndpoint:t,maxLogs:s,captureConsole:true,captureFetch:true,captureXHR:true,sanitizeKeys:["password","token","apiKey","secret","authorization","creditCard"],excludeUrls:["/api/analytics","google-analytics.com","facebook.com","vercel.com"]}),z=w(),v=h();useEffect(()=>{if(v.errorCount>=5&&t){let u=async()=>{try{await M();}catch{console.warn("[DebugPanel] Failed to auto-upload logs");}};return window.addEventListener("error",u),()=>window.removeEventListener("error",u)}},[v.errorCount,t,M]);let ne=useCallback((u,T)=>{if(S==="json")return JSON.stringify({metadata:T,logs:u},null,2);if(S==="ecs.json"){let Q=u.map(ae=>B(ae,T)),se={metadata:ee(T),logs:Q};return JSON.stringify(se,null,2)}else if(S==="ai.txt"){let Q=`# METADATA
